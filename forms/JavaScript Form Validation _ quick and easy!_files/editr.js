 ...
 */
 ...
 jQuery(function($) {
    ...
    var Editr = function(opts) {
        ...
        //PJ: added starttab
        var htmlOpts = ['path', 'readonly', 'theme', 'view', 'wrap','starttab'];
        ...
        var build = {
            ...
            nav: function() {
                ...
                if(data.files.html.length > 0 &&
                   data.files.html[0].isDefault != true)
                {
                    navs.push(build.navList('html', 'HTML'));
                }
                if(data.files.css.length > 0 &&
                   data.files.css[0].isDefault != true)
                {
                    navs.push(build.navList('css', 'CSS'));
                }
                if(data.files.js.length > 0 &&
                   data.files.js[0].isDefault != true)
                {
        ...
        var onLoaded = {
            ...
            bindNav: function() {
                ...
                if(opts.starttab !='')
                {
                    navItems.filter('[data-type='+opts.starttab+']').trigger('click');
                }
                else
                {
    ...
    if (typeof ender === 'undefined') {
        window.Editr = Editr;
        window.EditrInstances = EditrInstances;
    }
